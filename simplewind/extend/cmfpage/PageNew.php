...
class PageNew {
    ...
    private function firstprev(){
        if($this->page > 1) {
            $str = "<li class='page-item'><a  class='page-link' href='{$this->uri}page=1'>{$this->config["first"]}</a></li>";
            $str .= "<li class='page-item'><a href='{$this->uri}page=".($this->page-1)."'>{$this->config["prev"]}</a></li>";
            return $str;
        }
    ...
    private function pageList(){
        ...
        for($i = $inum; $i >= 1; $i--){
            ...
            if($page >= 1)
                $linkPage .= "<li class='page-item'><a class='page-link' href='{$this->uri}page={$page}'>{$page}</a></li>";
        }
        /*当前页的信息 */
        if($this->pageNum > 1)
            $linkPage .= "<li class=\"active page-item disabled\" ><span class=\"page-link\">{$this->page}</span></li>";
    ...
    private function nextlast(){
        if($this->page != $this->pageNum) {
            $str = "<li class='page-item'><a class='page-link' href='{$this->uri}page=".($this->page+1)."'>{$this->config["next"]}</a></li>";
            $str .= "<li class='page-item'><a class='page-link' href='{$this->uri}page=".($this->pageNum)."'>{$this->config["last"]}</a></li>";
            return $str;
        }
    }
